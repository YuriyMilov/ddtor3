...
public class mm extends HttpServlet {
	...
	public static void add_datastore(String s, String sid) {

		Key kk = KeyFactory.createKey(sid, "plus");
		Date date = new Date();
		Entity greeting = new Entity(sid, kk);
